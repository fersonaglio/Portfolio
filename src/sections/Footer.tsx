        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="w-10 h-10 rounded-full bg-pastel-blue flex items-center justify-center text-accent-teal hover:bg-accent-teal hover:text-white transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-pastel-pink flex items-center justify-center text-accent-pink hover:bg-accent-pink hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
